...
public final class UserLocation extends com.google.api.client.json.GenericJson {
   ...
   * For example 'Mountain View, CA', 'Near Seattle', 'US-NYC-9TH 9A209A.'' The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private java.lang.String area;

  /** Building Identifier. The value may be {@code null}. */
  ...
  /** Most specific textual code of individual desk location. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String deskCode;

  /** Floor name/number. The value may be {@code null}. */
   ...
   * sections 'A', 'B' and 'C' this field would identify one of those values. The value may be
   * {@code null}.
   */
   ...
   * customType value. The value may be {@code null}.
   */
