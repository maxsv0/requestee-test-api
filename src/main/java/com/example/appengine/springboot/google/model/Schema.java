...
public final class Schema extends com.google.api.client.json.GenericJson {
  ...
  /** Display name for the schema. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String displayName;

  /** The ETag of the resource. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String etag;

  /** A list of fields in the schema. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.util.List<SchemaFieldSpec> fields;

  /** Kind of resource this is. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String kind;

  /** The unique identifier of the schema (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String schemaId;

  /** The schema's name. The value may be {@code null}. */
