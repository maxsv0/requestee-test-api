...
public final class DirectoryChromeosdevicesIssueCommandRequest
    extends com.google.api.client.json.GenericJson {

  /** The type of command. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String commandType;
   ...
   * "volume": 50 }. The volume has to be an integer in the range [0,100]. The value may be {@code
   * null}.
   */
