...
public final class Customer extends com.google.api.client.json.GenericJson {
   ...
   * as the `customerDomain` The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String alternateEmail;

  /** The customer's creation time (Readonly) The value may be {@code null}. */
  @com.google.api.client.util.Key private com.google.api.client.util.DateTime customerCreationTime;

  /**
   * The customer's primary domain name string. Do not include the `www` prefix when creating a new
   * customer. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String customerDomain;

  /** ETag of the resource. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String etag;

  /**
   * The unique ID for the customer's Google Workspace account. (Readonly) The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private java.lang.String id;

  /**
   * Identifies the resource as a customer. Value: `admin#directory#customer` The value may be
   * {@code null}.
   */
   ...
   * value is `en`. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String language;

  /**
   * The customer's contact phone number in [E.164](https://en.wikipedia.org/wiki/E.164) format. The
   * value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String phoneNumber;

  /** The customer's postal address information. The value may be {@code null}. */
  @com.google.api.client.util.Key private CustomerPostalAddress postalAddress;
   ...
   */
  public Customer setCustomerCreationTime(
      com.google.api.client.util.DateTime customerCreationTime) {
