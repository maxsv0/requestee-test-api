...
public final class Building extends com.google.api.client.json.GenericJson {
   ...
   * region code are required. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private BuildingAddress address;

  /**
   * Unique identifier for the building. The maximum length is 100 characters. The value may be
   * {@code null}.
   */
   ...
   * "NYC-CHEL". The maximum length is 100 characters. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String buildingName;

  /**
   * The geographic coordinates of the center of the building, expressed as latitude and longitude
   * in decimal degrees. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private BuildingCoordinates coordinates;

  /**
   * A brief description of the building. For example, "Chelsea Market". The value may be {@code
   * null}.
   */
   ...
   * "2M", "3", "PH"] Must contain at least one entry. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.util.List<java.lang.String> floorNames;

  /** Kind of resource this is. The value may be {@code null}. */
