...
public final class FailureInfo extends com.google.api.client.json.GenericJson {
  ...
  /** Canonical code for why the update failed to apply. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String errorCode;

  /** Failure reason message. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String errorMessage;

  /** Failed printer. The value may be {@code null}. */
  @com.google.api.client.util.Key private Printer printer;

  /** Id of a failed printer. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String printerId;
