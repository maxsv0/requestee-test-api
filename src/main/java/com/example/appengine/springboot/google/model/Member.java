...
public final class Member extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Defines mail delivery preferences of member. This is only supported by create/update/get. The
   ...
   * changes. The value may be {@code null}.
   */
   ...
   * `memberKey`. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String id;

  /**
   * The type of the API resource. For Members resources, the value is `admin#directory#member`. The
   * value may be {@code null}.
   */
   ...
   * center](https://support.google.com/a/answer/167094). The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String role;

  /** Status of member (Immutable) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String status;

  /** The type of group member. The value may be {@code null}. */
