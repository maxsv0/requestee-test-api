...
public final class BatchCreatePrintersResponse extends com.google.api.client.json.GenericJson {
  ...
  /**
   * A list of create failures. Printer IDs are not populated, as printer were not created. The
   * value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.util.List<FailureInfo> failures;

  /**
   * A list of successfully created printers with their IDs populated. The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private java.util.List<Printer> printers;
