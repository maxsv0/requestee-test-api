 ...
 *
 * <p>Admin SDK lets administrators of enterprise domains to view and manage resources like user,
 * groups etc. It also provides audit and usage reports of domain.
 *
 * <p>For more information about this service, see the <a
 * href="http://developers.google.com/admin-sdk/" target="_blank">API Documentation</a>
 *
 * <p>This service uses {@link DirectoryRequestInitializer} to initialize global parameters via its
 * {@link Builder}.
 *
 * @since 1.3
 * @author Google, Inc.
...
public class Directory
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "You are currently running with version %s of google-api-client. "
            ...
            + "1.31.0 of the Admin SDK API library.",
  ...
  public class Asps {
     ...
     *
     * <p>Create a request for the method "asps.delete".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
     *
     * @param userKey Identifies the user in the API request. The value can be the user's primary
     *     email address, alias email address, or unique user ID.
     * @param codeId The unique ID of the ASP to be deleted.
     * @return the request
     */
    public Delete delete(java.lang.String userKey, java.lang.Integer codeId)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "asps.get".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     ...
     *
     * <p>Create a request for the method "asps.list".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
    ...
    public class Delete extends DirectoryRequest<Void> {
       ...
       */
      @com.google.api.client.util.Key private java.lang.String userKey;
      /** The unique ID of the ASP to be deleted. */
      @com.google.api.client.util.Key private java.lang.Integer codeId;
       ...
       * <p>Create a request for the method "asps.delete".
       *
       * <p>This request holds the parameters needed by the the admin server. After setting any
      ...
      protected Delete(java.lang.String userKey, java.lang.Integer codeId) {
        ...
        this.userKey =
            com.google.api.client.util.Preconditions.checkNotNull(
                userKey, "Required parameter userKey must be specified.");
        this.codeId =
            com.google.api.client.util.Preconditions.checkNotNull(
                codeId, "Required parameter codeId must be specified.");
      }
    ...
    public class Get extends DirectoryRequest<com.google.api.services.directory.model.Asp> {
      ...
      protected Get(java.lang.String userKey, java.lang.Integer codeId) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.Asp.class);
        this.userKey =
            com.google.api.client.util.Preconditions.checkNotNull(
                userKey, "Required parameter userKey must be specified.");
        this.codeId =
    ...
    public class List extends DirectoryRequest<com.google.api.services.directory.model.Asps> {
      ...
      protected List(java.lang.String userKey) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.Asps.class);
        this.userKey =
            com.google.api.client.util.Preconditions.checkNotNull(
                userKey, "Required parameter userKey must be specified.");
      }
  ...
  public class Channels {
     ...
     * @return the request
     */
    public Stop stop(com.google.api.services.directory.model.Channel content)
        throws java.io.IOException {
  ...
  public class Chromeosdevices {
     ...
     * re- enabling devices. *Warning:* * Deprovisioning a device will stop device policy syncing
     * and remove device-level printers. After a device is deprovisioned, it must be wiped before it
     * can be re- enrolled. * Lost or stolen devices should use the disable action. * Re-enabling a
     * disabled device will consume a device license. If you do not have sufficient licenses
     * available when completing the re-enable action, you will receive an error. For more
     ...
     *
     * <p>Create a request for the method "chromeosdevices.action".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Action#execute()} method to invoke the remote operation.
     *
     * @param customerId The unique ID for the customer's Google Workspace account. As an account
     ...
     * @param resourceId The unique ID of the device. The `resourceId`s are returned in the response
     *     from the [chromeosdevices.list](/admin-sdk/directory/v1/reference/chromeosdevices/list)
     *     method.
    ...
    public Action action(
        ...
        com.google.api.services.directory.model.ChromeOsDeviceAction content)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "chromeosdevices.get".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Get#execute()} method to invoke the remote operation.
     *
     ...
     *     `customerId`. The `customerId` is also returned as part of the [Users
     *     resource](/admin-sdk/directory/v1/reference/users).
     * @param deviceId The unique ID of the device. The `deviceId`s are returned in the response
     *     from the [chromeosdevices.list](/admin-sdk/directory/v1/reference/chromeosdevices/list)
     *     method.
     * @return the request
     */
    public Get get(java.lang.String customerId, java.lang.String deviceId)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "chromeosdevices.list".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link List#execute()} method to invoke the remote operation.
     *
     ...
     * devices at once.
     *
     * <p>Create a request for the method "chromeosdevices.moveDevicesToOu".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     ...
     * @return the request
     */
    public MoveDevicesToOu moveDevicesToOu(
        java.lang.String customerId,
        java.lang.String orgUnitPath,
        com.google.api.services.directory.model.ChromeOsMoveDevicesToOu content)
        throws java.io.IOException {
    ...
    /**
     * Updates a device's updatable properties, such as `annotatedUser`, `annotatedLocation`,
     * `notes`, `orgUnitPath`, or `annotatedAssetId`. This method supports [patch semantics](/admin-
     * sdk/directory/v1/guides/performance#patch).
     *
     * <p>Create a request for the method "chromeosdevices.patch".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     ...
     *     resource](/admin-sdk/directory/v1/reference/users).
     * @param deviceId The unique ID of the device. The `deviceId`s are returned in the response
     *     from the [chromeosdevices.list](/admin-sdk/v1/reference/chromeosdevices/list) method.
    ...
    public Patch patch(
        ...
        com.google.api.services.directory.model.ChromeOsDevice content)
        throws java.io.IOException {
    ...
    /**
     * Updates a device's updatable properties, such as `annotatedUser`, `annotatedLocation`,
     * `notes`, `orgUnitPath`, or `annotatedAssetId`.
     *
     * <p>Create a request for the method "chromeosdevices.update".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
    ...
    public class Action extends DirectoryRequest<Void> {
       ...
       */
      @com.google.api.client.util.Key private java.lang.String customerId;
      /**
       ...
       */
      @com.google.api.client.util.Key private java.lang.String resourceId;

      /**
       * Takes an action that affects a Chrome OS Device. This includes deprovisioning, disabling,
       * and re-enabling devices. *Warning:* * Deprovisioning a device will stop device policy
       * syncing and remove device-level printers. After a device is deprovisioned, it must be wiped
       * before it can be re-enrolled. * Lost or stolen devices should use the disable action. *
       * Re-enabling a disabled device will consume a device license. If you do not have sufficient
       * licenses available when completing the re-enable action, you will receive an error. For
       * more information about deprovisioning and disabling devices, visit the [help
       * center](https://support.google.com/chrome/a/answer/3523633).
       *
       * <p>Create a request for the method "chromeosdevices.action".
       *
       * <p>This request holds the parameters needed by the the admin server. After setting any
       * optional parameters, call the {@link Action#execute()} method to invoke the remote
       * operation.
       *
       * <p>{@link
       * Action#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
       * must be called to initialize this instance immediately after invoking the constructor.
       *
       * @param customerId The unique ID for the customer's Google Workspace account. As an account
       *     administrator, you can also use the `my_customer` alias to represent your account's
       *     `customerId`. The `customerId` is also returned as part of the [Users
       *     resource](/admin-sdk/directory/v1/reference/users).
       * @param resourceId The unique ID of the device. The `resourceId`s are returned in the
       *     response from the
       *     [chromeosdevices.list](/admin-sdk/directory/v1/reference/chromeosdevices/list) method.
       * @param content the {@link com.google.api.services.directory.model.ChromeOsDeviceAction}
       * @since 1.13
      ...
      protected Action(
        ...
        this.customerId =
            com.google.api.client.util.Preconditions.checkNotNull(
                customerId, "Required parameter customerId must be specified.");
        this.resourceId =
            com.google.api.client.util.Preconditions.checkNotNull(
                resourceId, "Required parameter resourceId must be specified.");
      }
    ...
    public class Get
        extends DirectoryRequest<com.google.api.services.directory.model.ChromeOsDevice> {
       ...
       * [chromeosdevices.list](/admin-sdk/directory/v1/reference/chromeosdevices/list) method.
       */
      @com.google.api.client.util.Key private java.lang.String deviceId;
      /** Determines whether the response contains the full list of properties or only a subset. */
      @com.google.api.client.util.Key private java.lang.String projection;
      ...
      protected Get(java.lang.String customerId, java.lang.String deviceId) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.ChromeOsDevice.class);
        this.customerId =
            com.google.api.client.util.Preconditions.checkNotNull(
                customerId, "Required parameter customerId must be specified.");
        this.deviceId =
    ...
    public class List
        extends DirectoryRequest<com.google.api.services.directory.model.ChromeOsDevices> {
      ...
      @com.google.api.client.util.Key private java.lang.Integer maxResults;
      ...
      @com.google.api.client.util.Key private java.lang.String orgUnitPath;
      /**
       ...
       */
      @com.google.api.client.util.Key private java.lang.String query;
      /**
      ...
      protected List(java.lang.String customerId) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.ChromeOsDevices.class);
        this.customerId =
            com.google.api.client.util.Preconditions.checkNotNull(
                customerId, "Required parameter customerId must be specified.");
      }
    ...
    public class MoveDevicesToOu extends DirectoryRequest<Void> {
       ...
       *
       * <p>This request holds the parameters needed by the the admin server. After setting any
       * optional parameters, call the {@link MoveDevicesToOu#execute()} method to invoke the remote
       * operation.
       *
       * <p>{@link
       * MoveDevicesToOu#initialize(com.google.api.client.googleapis.services.AbstractGoogleC
      ...
      protected MoveDevicesToOu(
        ...
        this.orgUnitPath =
            com.google.api.client.util.Preconditions.checkNotNull(
                orgUnitPath, "Required parameter orgUnitPath must be specified.");
      }
    ...
    public class Patch
      ...
      /**
       * Updates a device's updatable properties, such as `annotatedUser`, `annotatedLocation`,
       * `notes`, `orgUnitPath`, or `annotatedAssetId`. This method supports [patch
  ...
  public class Customer {
    ...
    public class Devices {
      ...
      public class Chromeos {
         ...
         *
         * <p>Create a request for the method "chromeos.issueCommand".
         *
         * <p>This request holds the parameters needed by the admin server. After setting any
         ...
         *     com.google.api.services.directory.model.DirectoryChromeosdevicesIssueCommandRequest}
         * @return the request
         */
        public IssueCommand issueCommand(
            java.lang.String customerId,
            java.lang.String deviceId,
            com.google.api.services.directory.model.DirectoryChromeosdevicesIssueCommandRequest
                content)
        ...
        public class IssueCommand
           ...
           *
           * <p>This request holds the parameters needed by the the admin server. After setting any
           * optional parameters, call the {@link IssueCommand#execute()} method to invoke the
           * remote operation.
           *
           * <p>{@link
          ...
          protected IssueCommand(
            ...
            super(
                ...
                REST_PATH,
                content,
                com.google.api.services.directory.model.DirectoryChromeosdevicesIssueCommandResponse
                    .class);
            this.customerId =
                com.google.api.client.util.Preconditions.checkNotNull(
                    customerId, "Required parameter customerId must be specified.");
        ...
        public class Commands {
           ...
           *
           * <p>Create a request for the method "commands.get".
           *
           * <p>This request holds the parameters needed by the admin server. After setting any
           ...
           */
          public Get get(
              java.lang.String customerId, java.lang.String deviceId, java.lang.Long commandId)
              throws java.io.IOException {
          ...
          public class Get
              extends DirectoryRequest<
                  com.google.api.services.directory.model.DirectoryChromeosdevicesCommand> {
            ...
            @com.google.api.client.util.Key private java.lang.Long commandId;
             ...
             * <p>Create a request for the method "commands.get".
             *
             * <p>This request holds the parameters needed by the the admin server. After setting
            ...
            protected Get(
              ...
              super(
                  ...
                  REST_PATH,
                  null,
                  com.google.api.services.directory.model.DirectoryChromeosdevicesCommand.class);
              this.customerId =
                  com.google.api.client.util.Preconditions.checkNotNull(
                      customerId, "Required parameter customerId must be specified.");
              this.deviceId =
              ...
              this.commandId =
                  com.google.api.client.util.Preconditions.checkNotNull(
                      commandId, "Required parameter commandId must be specified.");
            }
  ...
  public class Customers {
     ...
     *
     * <p>Create a request for the method "customers.get".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Get#execute()} method to invoke the remote operation.
     *
     ...
     *
     * <p>Create a request for the method "customers.patch".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Patch#execute()} method to invoke the remote operation.
     *
     ...
     */
    public Patch patch(
        java.lang.String customerKey, com.google.api.services.directory.model.Customer content)
        throws java.io.IOException {
     ...
     * Updates a customer.
     *
     * <p>Create a request for the method "customers.update".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Update#execute()} method to invoke the remote operation.
     *
    ...
    public class Get extends DirectoryRequest<com.google.api.services.directory.model.Customer> {
      ...
      @com.google.api.client.util.Key private java.lang.String customerKey;
      ...
      protected Get(java.lang.String customerKey) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.Customer.class);
        this.customerKey =
            com.google.api.client.util.Preconditions.checkNotNull(
                customerKey, "Required parameter customerKey must be specified.");
      }
    ...
    public class Chrome {
      ...
      public class Printers {
         ...
         *
         * <p>Create a request for the method "printers.batchCreatePrinters".
         *
         * <p>This request holds the parameters needed by the admin server. After setting any
         * optional parameters, call the {@link BatchCreatePrinters#execute()} method to invoke the
         * remote operation.
         *
         * @param parent Required. The name of the customer. Format: customers/{customer_id}
         * @param content the {@link
         *     com.google.api.services.directory.model.BatchCreatePrintersRequest}
         * @return the request
         */
        public BatchCreatePrinters batchCreatePrinters(
            java.lang.String parent,
            com.google.api.services.directory.model.BatchCreatePrintersRequest content)
            throws java.io.IOException {
         ...
         *
         * <p>Create a request for the method "printers.batchDeletePrinters".
         *
         * <p>This request holds the parameters needed by the admin server. After setting any
         * optional parameters, call the {@link BatchDeletePrinters#execute()} method to invoke the
         * remote operation.
         *
         * @param parent Required. The name of the customer. Format: customers/{customer_id}
         * @param content the {@link
         *     com.google.api.services.directory.model.BatchDeletePrintersRequest}
         * @return the request
         */
        public BatchDeletePrinters batchDeletePrinters(
            java.lang.String parent,
            com.google.api.services.directory.model.BatchDeletePrintersRequest content)
            throws java.io.IOException {
         ...
         *
         * <p>Create a request for the method "printers.create".
         *
         * <p>This request holds the parameters needed by the admin server. After setting any
        ...
        public Create create(
            java.lang.String parent, com.google.api.services.directory.model.Printer content)
            throws java.io.IOException {
         ...
         * Deletes a `Printer`.
         *
         * <p>Create a request for the method "printers.delete".
         *
         * <p>This request holds the parameters needed by the admin server. After setting any
         * optional parameters, call the {@link Delete#execute()} method to invoke the remote
         * operation.
         ...
         *
         * <p>Create a request for the method "printers.get".
         *
         * <p>This request holds the parameters needed by the admin server. After setting any
         * optional parameters, call the {@link Get#execute()} method to invoke the remote
         * operation.
         ...
         *
         * <p>Create a request for the method "printers.list".
         *
         * <p>This request holds the parameters needed by the admin server. After setting any
         * optional parameters, call the {@link List#execute()} method to invoke the remote
         * operation.
         *
         * @param parent Required. The name of the customer who owns this collection of printers.
         ...
         *
         * <p>Create a request for the method "printers.listPrinterModels".
         *
         * <p>This request holds the parameters needed by the admin server. After setting any
         * optional parameters, call the {@link ListPrinterModels#execute()} method to invoke the
         * remote operation.
         *
         * @param parent Required. The name of the customer who owns this collection of printers.
         *     Format: customers/{customer_id}
         * @return the request
         */
        public ListPrinterModels listPrinterModels(java.lang.String parent)
            throws java.io.IOException {
         ...
         *
         * <p>Create a request for the method "printers.patch".
         *
         * <p>This request holds the parameters needed by the admin server. After setting any
         * optional parameters, call the {@link Patch#execute()} method to invoke the remote
         * operation.
         ...
         */
        public Patch patch(
            java.lang.String name, com.google.api.services.directory.model.Printer content)
            throws java.io.IOException {
        ...
        public class BatchCreatePrinters
            extends DirectoryRequest<
                com.google.api.services.directory.model.BatchCreatePrintersResponse> {
           ...
           *
           * <p>This request holds the parameters needed by the the admin server. After setting any
           * optional parameters, call the {@link BatchCreatePrinters#execute()} method to invoke
           * the remote operation.
           *
           * <p>{@link BatchCreatePrinters#initialize(com.google.api.client.googleapis.services.
           * AbstractGoogleClientRequest)} must be called to initialize this instance immediately
          ...
          protected BatchCreatePrinters(
            ...
            super(
                ...
                REST_PATH,
                content,
                com.google.api.services.directory.model.BatchCreatePrintersResponse.class);
            this.parent =
                com.google.api.client.util.Preconditions.checkNotNull(
            ...
            if (!getSuppressPatternChecks()) {
              com.google.api.client.util.Preconditions.checkArgument(
                  ...
                  "Parameter parent must conform to the pattern " + "^customers/[^/]+$");
            }
          }
        ...
        public class BatchDeletePrinters
            extends DirectoryRequest<
                com.google.api.services.directory.model.BatchDeletePrintersResponse> {
           ...
           *
           * <p>This request holds the parameters needed by the the admin server. After setting any
           * optional parameters, call the {@link BatchDeletePrinters#execute()} method to invoke
           * the remote operation.
           *
           * <p>{@link BatchDeletePrinters#initialize(com.google.api.client.googleapis.services.
           * AbstractGoogleClientRequest)} must be called to initialize this instance immediately
           * after invoking the constructor.
           *
           * @param parent Required. The name of the customer. Format: customers/{customer_id}
          ...
          protected BatchDeletePrinters(
            ...
            super(
                ...
                REST_PATH,
                content,
                com.google.api.services.directory.model.BatchDeletePrintersResponse.class);
            this.parent =
                com.google.api.client.util.Preconditions.checkNotNull(
                    parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
        ...
        public class Create
            extends DirectoryRequest<com.google.api.services.directory.model.Printer> {
          ...
          protected Create(
            ...
            super(
                ...
                REST_PATH,
                content,
                com.google.api.services.directory.model.Printer.class);
            this.parent =
                com.google.api.client.util.Preconditions.checkNotNull(
                    parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
        ...
        public class Delete
            extends DirectoryRequest<com.google.api.services.directory.model.Empty> {
          ...
          protected Delete(java.lang.String name) {
            super(
                ...
                REST_PATH,
                null,
                com.google.api.services.directory.model.Empty.class);
            this.name =
                com.google.api.client.util.Preconditions.checkNotNull(
        ...
        public class List
            extends DirectoryRequest<com.google.api.services.directory.model.ListPrintersResponse> {
           ...
           */
          @com.google.api.client.util.Key private java.lang.String orgUnitId;
          /**
          ...
          protected List(java.lang.String parent) {
            super(
                ...
                REST_PATH,
                null,
                com.google.api.services.directory.model.ListPrintersResponse.class);
            this.parent =
                com.google.api.client.util.Preconditions.checkNotNull(
                    parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
        ...
        public class ListPrinterModels
            extends DirectoryRequest<
                com.google.api.services.directory.model.ListPrinterModelsResponse> {
           ...
           *
           * <p>{@link
           * ListPrinterModels#initialize(com.google.api.client.googleapis.services.AbstractGoogl
           * eClientRequest)} must be called to initialize this instance immediately after invoking
           * the constructor.
           *
           * @param parent Required. The name of the customer who owns this collection of printers.
           *     Format: customers/{customer_id}
          ...
          protected ListPrinterModels(java.lang.String parent) {
            super(
                ...
                REST_PATH,
                null,
                com.google.api.services.directory.model.ListPrinterModelsResponse.class);
            this.parent =
                com.google.api.client.util.Preconditions.checkNotNull(
                    parent, "Required parameter parent must be specified.");
            if (!getSuppressPatternChecks()) {
        ...
        public class Patch
           ...
           */
          @com.google.api.client.util.Key private String clearMask;
          /**
  ...
  public class DomainAliases {
     ...
     *
     * <p>Create a request for the method "domainAliases.delete".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
     *
     ...
     * @return the request
     */
    public Delete delete(java.lang.String customer, java.lang.String domainAliasName)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "domainAliases.get".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Get#execute()} method to invoke the remote operation.
     *
     ...
     * @return the request
     */
    public Get get(java.lang.String customer, java.lang.String domainAliasName)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "domainAliases.insert".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
    ...
    public Insert insert(
        java.lang.String customer, com.google.api.services.directory.model.DomainAlias content)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "domainAliases.list".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link List#execute()} method to invoke the remote operation.
     *
    ...
    public class Delete extends DirectoryRequest<Void> {
      ...
      /** Immutable ID of the Google Workspace account. */
      @com.google.api.client.util.Key private java.lang.String customer;
      /** Name of domain alias to be retrieved. */
      @com.google.api.client.util.Key private java.lang.String domainAliasName;
      ...
      protected Delete(java.lang.String customer, java.lang.String domainAliasName) {
        ...
        this.customer =
            com.google.api.client.util.Preconditions.checkNotNull(
                customer, "Required parameter customer must be specified.");
        this.domainAliasName =
            com.google.api.client.util.Preconditions.checkNotNull(
                domainAliasName, "Required parameter domainAliasName must be specified.");
      }
    ...
    public class Get extends DirectoryRequest<com.google.api.services.directory.model.DomainAlias> {
      ...
      protected Get(java.lang.String customer, java.lang.String domainAliasName) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.DomainAlias.class);
        this.customer =
            com.google.api.client.util.Preconditions.checkNotNull(
                customer, "Required parameter customer must be specified.");
        this.domainAliasName =
    ...
    public class Insert
        extends DirectoryRequest<com.google.api.services.directory.model.DomainAlias> {
    ...
    public class List
      ...
      @com.google.api.client.util.Key private java.lang.String parentDomainName;
      ...
      protected List(java.lang.String customer) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.DomainAliases.class);
        this.customer =
            com.google.api.client.util.Preconditions.checkNotNull(
                customer, "Required parameter customer must be specified.");
      }
  ...
  public class Domains {
     ...
     *
     * <p>Create a request for the method "domains.delete".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
     *
     ...
     * @return the request
     */
    public Delete delete(java.lang.String customer, java.lang.String domainName)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "domains.get".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Get#execute()} method to invoke the remote operation.
     *
     ...
     * @return the request
     */
    public Get get(java.lang.String customer, java.lang.String domainName)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "domains.insert".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
     *
     ...
     */
    public Insert insert(
        java.lang.String customer, com.google.api.services.directory.model.Domains content)
        throws java.io.IOException {
      Insert result = new Insert(customer, content);
      initialize(result);
      return result;
     ...
     *
     * <p>Create a request for the method "domains.list".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link List#execute()} method to invoke the remote operation.
     *
    ...
    public class Delete extends DirectoryRequest<Void> {
      ...
      @com.google.api.client.util.Key private java.lang.String domainName;
      ...
      protected Delete(java.lang.String customer, java.lang.String domainName) {
        ...
        this.domainName =
            com.google.api.client.util.Preconditions.checkNotNull(
                domainName, "Required parameter domainName must be specified.");
      }
    ...
    public class Get extends DirectoryRequest<com.google.api.services.directory.model.Domains> {
      ...
      protected Get(java.lang.String customer, java.lang.String domainName) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.Domains.class);
        this.customer =
            com.google.api.client.util.Preconditions.checkNotNull(
                customer, "Required parameter customer must be specified.");
        this.domainName =
    ...
    public class List extends DirectoryRequest<com.google.api.services.directory.model.Domains2> {
      ...
      protected List(java.lang.String customer) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.Domains2.class);
        this.customer =
            com.google.api.client.util.Preconditions.checkNotNull(
                customer, "Required parameter customer must be specified.");
      }
  ...
  public class Groups {
     ...
     * Deletes a group.
     *
     * <p>Create a request for the method "groups.delete".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
     *
     * @param groupKey Identifies the group in the API request. The value can be the group's email
     ...
     *
     * <p>Create a request for the method "groups.get".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Get#execute()} method to invoke the remote operation.
     *
     ...
     * Creates a group.
     *
     * <p>Create a request for the method "groups.insert".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
     *
     ...
     * @return the request
     */
    public Insert insert(com.google.api.services.directory.model.Group content)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "groups.list".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link List#execute()} method to invoke the remote operation.
     *
     ...
     * sdk/directory/v1/guides/performance#patch).
     *
     * <p>Create a request for the method "groups.patch".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Patch#execute()} method to invoke the remote operation.
     *
     ...
     */
    public Patch patch(
        java.lang.String groupKey, com.google.api.services.directory.model.Group content)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "groups.update".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Update#execute()} method to invoke the remote operation.
     *
    ...
    public class Delete extends DirectoryRequest<Void> {
       ...
       */
      @com.google.api.client.util.Key private java.lang.String groupKey;
      ...
      protected Delete(java.lang.String groupKey) {
        ...
        this.groupKey =
            com.google.api.client.util.Preconditions.checkNotNull(
                groupKey, "Required parameter groupKey must be specified.");
      }
    ...
    public class Get extends DirectoryRequest<com.google.api.services.directory.model.Group> {
      ...
      protected Get(java.lang.String groupKey) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.Group.class);
        this.groupKey =
            com.google.api.client.util.Preconditions.checkNotNull(
                groupKey, "Required parameter groupKey must be specified.");
      }
    ...
    public class List extends DirectoryRequest<com.google.api.services.directory.model.Groups> {
       ...
       */
      @com.google.api.client.util.Key private java.lang.String domain;
      ...
      protected List() {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.Groups.class);
      }
       ...
       * account, to fetch all groups for a customer, fill this field instead of domain. As an
       * account administrator, you can also use the `my_customer` alias to represent your account's
       * `customerId`. The `customerId` is also returned as part of the
    ...
    public class Aliases {
       ...
       * Removes an alias.
       *
       * <p>Create a request for the method "aliases.delete".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
       *
       ...
       * @return the request
       */
      public Delete delete(java.lang.String groupKey, java.lang.String alias)
          throws java.io.IOException {
       ...
       *
       * <p>Create a request for the method "aliases.insert".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
       *
       ...
       */
      public Insert insert(
          java.lang.String groupKey, com.google.api.services.directory.model.Alias content)
          throws java.io.IOException {
       ...
       *
       * <p>Create a request for the method "aliases.list".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link List#execute()} method to invoke the remote operation.
       *
      ...
      public class Delete extends DirectoryRequest<Void> {
         ...
         * must be called to initialize this instance immediately after invoking the constructor.
         *
         * @param groupKey Identifies the group in the API request. The value can be the group's
        ...
        protected Delete(java.lang.String groupKey, java.lang.String alias) {
          ...
          this.alias =
              com.google.api.client.util.Preconditions.checkNotNull(
                  alias, "Required parameter alias must be specified.");
        }
      ...
      public class Insert extends DirectoryRequest<com.google.api.services.directory.model.Alias> {
        ...
        protected Insert(
          ...
          super(
              ...
              REST_PATH,
              content,
              com.google.api.services.directory.model.Alias.class);
          this.groupKey =
              com.google.api.client.util.Preconditions.checkNotNull(
                  groupKey, "Required parameter groupKey must be specified.");
        }
      ...
      public class List extends DirectoryRequest<com.google.api.services.directory.model.Aliases> {
        ...
        protected List(java.lang.String groupKey) {
          super(
              ...
              REST_PATH,
              null,
              com.google.api.services.directory.model.Aliases.class);
          this.groupKey =
              com.google.api.client.util.Preconditions.checkNotNull(
                  groupKey, "Required parameter groupKey must be specified.");
        }
  ...
  public class Members {
     ...
     *
     * <p>Create a request for the method "members.delete".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
     *
     * @param groupKey Identifies the group in the API request. The value can be the group's email
     *     address, group alias, or the unique group ID.
     * @param memberKey Identifies the group member in the API request. A group member can be a user
     *     or another group. The value can be the member's (group or user) primary email address,
     *     alias, or unique ID.
     * @return the request
     */
    public Delete delete(java.lang.String groupKey, java.lang.String memberKey)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "members.get".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Get#execute()} method to invoke the remote operation.
     *
     ...
     * @return the request
     */
    public Get get(java.lang.String groupKey, java.lang.String memberKey)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "members.hasMember".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     ...
     * @param groupKey Identifies the group in the API request. The value can be the group's email
     *     address, group alias, or the unique group ID.
     * @param memberKey Identifies the user member in the API request. The value can be the user's
     *     primary email address, alias, or unique ID.
     * @return the request
     */
    public HasMember hasMember(java.lang.String groupKey, java.lang.String memberKey)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "members.insert".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
     *
     ...
     */
    public Insert insert(
        java.lang.String groupKey, com.google.api.services.directory.model.Member content)
        throws java.io.IOException {
      Insert result = new Insert(groupKey, content);
      initialize(result);
      return result;
     ...
     *
     * <p>Create a request for the method "members.list".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link List#execute()} method to invoke the remote operation.
     *
     ...
     * [patch semantics](/admin-sdk/directory/v1/guides/performance#patch).
     *
     * <p>Create a request for the method "members.patch".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Patch#execute()} method to invoke the remote operation.
     *
    ...
    public Patch patch(
        ...
        com.google.api.services.directory.model.Member content)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "members.update".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Update#execute()} method to invoke the remote operation.
     *
    ...
    public class Delete extends DirectoryRequest<Void> {
       ...
       * unique ID.
       */
      @com.google.api.client.util.Key private java.lang.String memberKey;
       ...
       * @param groupKey Identifies the group in the API request. The value can be the group's email
       *     address, group alias, or the unique group ID.
       * @param memberKey Identifies the group member in the API request. A group member can be a
       *     user or another group. The value can be the member's (group or user) primary email
      ...
      protected Delete(java.lang.String groupKey, java.lang.String memberKey) {
        ...
        this.memberKey =
            com.google.api.client.util.Preconditions.checkNotNull(
                memberKey, "Required parameter memberKey must be specified.");
      }
    ...
    public class Get extends DirectoryRequest<com.google.api.services.directory.model.Member> {
      ...
      protected Get(java.lang.String groupKey, java.lang.String memberKey) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.Member.class);
        this.groupKey =
            com.google.api.client.util.Preconditions.checkNotNull(
                groupKey, "Required parameter groupKey must be specified.");
        this.memberKey =
    ...
    public class HasMember
        extends DirectoryRequest<com.google.api.services.directory.model.MembersHasMember> {
       ...
       *
       * <p>This request holds the parameters needed by the the admin server. After setting any
       * optional parameters, call the {@link HasMember#execute()} method to invoke the remote
       * operation.
       *
       * <p>{@link
      ...
      protected HasMember(java.lang.String groupKey, java.lang.String memberKey) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.MembersHasMember.class);
        this.groupKey =
            com.google.api.client.util.Preconditions.checkNotNull(
                groupKey, "Required parameter groupKey must be specified.");
        this.memberKey =
    ...
    public class List extends DirectoryRequest<com.google.api.services.directory.model.Members> {
      ...
      @com.google.api.client.util.Key private java.lang.Boolean includeDerivedMembership;
      /** Maximum number of results to return. Max allowed value is 200. */
      @com.google.api.client.util.Key private java.lang.Integer maxResults;
      /** Token to specify next page in the list. */
      @com.google.api.client.util.Key private java.lang.String pageToken;
       ...
       */
      @com.google.api.client.util.Key private java.lang.String roles;
      ...
      protected List(java.lang.String groupKey) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.Members.class);
        this.groupKey =
            com.google.api.client.util.Preconditions.checkNotNull(
                groupKey, "Required parameter groupKey must be specified.");
      }
  ...
  public class Mobiledevices {
     ...
     *
     * <p>Create a request for the method "mobiledevices.action".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Action#execute()} method to invoke the remote operation.
     *
    ...
    public Action action(
        java.lang.String customerId,
        java.lang.String resourceId,
        com.google.api.services.directory.model.MobileDeviceAction content)
        throws java.io.IOException {
      Action result = new Action(customerId, resourceId, content);
      initialize(result);
      return result;
     ...
     *
     * <p>Create a request for the method "mobiledevices.delete".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
     *
     ...
     * @return the request
     */
    public Delete delete(java.lang.String customerId, java.lang.String resourceId)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "mobiledevices.get".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Get#execute()} method to invoke the remote operation.
     *
     ...
     * @return the request
     */
    public Get get(java.lang.String customerId, java.lang.String resourceId)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "mobiledevices.list".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link List#execute()} method to invoke the remote operation.
     *
    ...
    public class Get
        extends DirectoryRequest<com.google.api.services.directory.model.MobileDevice> {
      ...
      protected Get(java.lang.String customerId, java.lang.String resourceId) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.MobileDevice.class);
        this.customerId =
            com.google.api.client.util.Preconditions.checkNotNull(
                customerId, "Required parameter customerId must be specified.");
        this.resourceId =
    ...
    public class List
        extends DirectoryRequest<com.google.api.services.directory.model.MobileDevices> {
      ...
      protected List(java.lang.String customerId) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.MobileDevices.class);
        this.customerId =
            com.google.api.client.util.Preconditions.checkNotNull(
                customerId, "Required parameter customerId must be specified.");
      }
  ...
  public class Orgunits {
     ...
     *
     * <p>Create a request for the method "orgunits.delete".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
     *
     ...
     * @return the request
     */
    public Delete delete(java.lang.String customerId, java.lang.String orgUnitPath)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "orgunits.get".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Get#execute()} method to invoke the remote operation.
     *
     ...
     * @return the request
     */
    public Get get(java.lang.String customerId, java.lang.String orgUnitPath)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "orgunits.insert".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
     *
     ...
     */
    public Insert insert(
        java.lang.String customerId, com.google.api.services.directory.model.OrgUnit content)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "orgunits.list".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link List#execute()} method to invoke the remote operation.
     *
     ...
     * sdk/directory/v1/guides/performance#patch)
     *
     * <p>Create a request for the method "orgunits.patch".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Patch#execute()} method to invoke the remote operation.
     *
    ...
    public Patch patch(
        java.lang.String customerId,
        java.lang.String orgUnitPath,
        com.google.api.services.directory.model.OrgUnit content)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "orgunits.update".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Update#execute()} method to invoke the remote operation.
     *
    ...
    public class Delete extends DirectoryRequest<Void> {
      ...
      @com.google.api.client.util.Key private java.lang.Boolean allowPlus;
      ...
      protected Delete(java.lang.String customerId, java.lang.String orgUnitPath) {
        ...
        if (!getSuppressPatternChecks()) {
          com.google.api.client.util.Preconditions.checkArgument(
              ORG_UNIT_PATH_PATTERN.matcher(orgUnitPath).matches(),
    ...
    public class Get extends DirectoryRequest<com.google.api.services.directory.model.OrgUnit> {
      ...
      protected Get(java.lang.String customerId, java.lang.String orgUnitPath) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.OrgUnit.class);
        this.customerId =
            com.google.api.client.util.Preconditions.checkNotNull(
                customerId, "Required parameter customerId must be specified.");
        this.orgUnitPath =
    ...
    public class List extends DirectoryRequest<com.google.api.services.directory.model.OrgUnits> {
      ...
      protected List(java.lang.String customerId) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.OrgUnits.class);
        this.customerId =
            com.google.api.client.util.Preconditions.checkNotNull(
                customerId, "Required parameter customerId must be specified.");
      }
  ...
  public class Privileges {
     ...
     *
     * <p>Create a request for the method "privileges.list".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link List#execute()} method to invoke the remote operation.
     *
    ...
    public class List extends DirectoryRequest<com.google.api.services.directory.model.Privileges> {
      ...
      protected List(java.lang.String customer) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.Privileges.class);
        this.customer =
            com.google.api.client.util.Preconditions.checkNotNull(
                customer, "Required parameter customer must be specified.");
      }
  ...
  public class Resources {
    ...
    public class Buildings {
       ...
       * Deletes a building.
       *
       * <p>Create a request for the method "buildings.delete".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
       *
       * @param customer The unique ID for the customer's Google Workspace account. As an account
       *     administrator, you can also use the `my_customer` alias to represent your account's
       *     customer ID.
       * @param buildingId The id of the building to delete.
       * @return the request
       */
      public Delete delete(java.lang.String customer, java.lang.String buildingId)
          throws java.io.IOException {
       ...
       *
       * <p>Create a request for the method "buildings.get".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Get#execute()} method to invoke the remote operation.
       *
       ...
       * @return the request
       */
      public Get get(java.lang.String customer, java.lang.String buildingId)
          throws java.io.IOException {
       ...
       * Inserts a building.
       *
       * <p>Create a request for the method "buildings.insert".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
       *
       ...
       */
      public Insert insert(
          java.lang.String customer, com.google.api.services.directory.model.Building content)
          throws java.io.IOException {
        Insert result = new Insert(customer, content);
        initialize(result);
        return result;
       ...
       *
       * <p>Create a request for the method "buildings.list".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link List#execute()} method to invoke the remote operation.
       *
       ...
       *
       * <p>Create a request for the method "buildings.patch".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Patch#execute()} method to invoke the remote operation.
       *
      ...
      public Patch patch(
          ...
          com.google.api.services.directory.model.Building content)
          throws java.io.IOException {
       ...
       * Updates a building.
       *
       * <p>Create a request for the method "buildings.update".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Update#execute()} method to invoke the remote operation.
       *
      ...
      public class Delete extends DirectoryRequest<Void> {
        ...
        @com.google.api.client.util.Key private java.lang.String buildingId;
        ...
        protected Delete(java.lang.String customer, java.lang.String buildingId) {
          ...
          this.buildingId =
              com.google.api.client.util.Preconditions.checkNotNull(
                  buildingId, "Required parameter buildingId must be specified.");
        }
      ...
      public class Get extends DirectoryRequest<com.google.api.services.directory.model.Building> {
        ...
        protected Get(java.lang.String customer, java.lang.String buildingId) {
          super(
              ...
              REST_PATH,
              null,
              com.google.api.services.directory.model.Building.class);
          this.customer =
              com.google.api.client.util.Preconditions.checkNotNull(
                  customer, "Required parameter customer must be specified.");
          this.buildingId =
      ...
      public class Insert
          extends DirectoryRequest<com.google.api.services.directory.model.Building> {
        ...
        @com.google.api.client.util.Key private java.lang.String coordinatesSource;
      ...
      public class List
        ...
        protected List(java.lang.String customer) {
          super(
              ...
              REST_PATH,
              null,
              com.google.api.services.directory.model.Buildings.class);
          this.customer =
              com.google.api.client.util.Preconditions.checkNotNull(
                  customer, "Required parameter customer must be specified.");
        }
    ...
    public class Calendars {
       ...
       *
       * <p>Create a request for the method "calendars.delete".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
       *
       ...
       * @return the request
       */
      public Delete delete(java.lang.String customer, java.lang.String calendarResourceId)
          throws java.io.IOException {
       ...
       *
       * <p>Create a request for the method "calendars.get".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Get#execute()} method to invoke the remote operation.
       *
       ...
       *
       * <p>Create a request for the method "calendars.insert".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
       *
      ...
      public Insert insert(
          java.lang.String customer,
          com.google.api.services.directory.model.CalendarResource content)
          throws java.io.IOException {
        Insert result = new Insert(customer, content);
        initialize(result);
        return result;
       ...
       *
       * <p>Create a request for the method "calendars.list".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link List#execute()} method to invoke the remote operation.
       *
       ...
       *
       * <p>Create a request for the method "calendars.patch".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Patch#execute()} method to invoke the remote operation.
       *
       ...
       * preserved.
       *
       * <p>Create a request for the method "calendars.update".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Update#execute()} method to invoke the remote operation.
       *
      ...
      public class Delete extends DirectoryRequest<Void> {
        ...
        @com.google.api.client.util.Key private java.lang.String calendarResourceId;
        ...
        protected Delete(java.lang.String customer, java.lang.String calendarResourceId) {
          ...
          this.calendarResourceId =
              com.google.api.client.util.Preconditions.checkNotNull(
                  calendarResourceId, "Required parameter calendarResourceId must be specified.");
        }
      ...
      public class Get
          extends DirectoryRequest<com.google.api.services.directory.model.CalendarResource> {
        ...
        protected Get(java.lang.String customer, java.lang.String calendarResourceId) {
          super(
              ...
              REST_PATH,
              null,
              com.google.api.services.directory.model.CalendarResource.class);
          this.customer =
              com.google.api.client.util.Preconditions.checkNotNull(
                  customer, "Required parameter customer must be specified.");
          this.calendarResourceId =
      ...
      public class List
          extends DirectoryRequest<com.google.api.services.directory.model.CalendarResources> {
        ...
        protected List(java.lang.String customer) {
          super(
              ...
              REST_PATH,
              null,
              com.google.api.services.directory.model.CalendarResources.class);
          this.customer =
              com.google.api.client.util.Preconditions.checkNotNull(
                  customer, "Required parameter customer must be specified.");
        }
      ...
      public class Update
        ...
        /**
         * Updates a calendar resource. This method supports patch semantics, meaning you only need
         * to include the fields you wish to update. Fields that are not present in the request will
         * be preserved.
         *
         * <p>Create a request for the method "calendars.update".
         *
    ...
    public class Features {
       ...
       * Deletes a feature.
       *
       * <p>Create a request for the method "features.delete".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
       *
       ...
       * @return the request
       */
      public Delete delete(java.lang.String customer, java.lang.String featureKey)
          throws java.io.IOException {
       ...
       * Retrieves a feature.
       *
       * <p>Create a request for the method "features.get".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Get#execute()} method to invoke the remote operation.
       *
       ...
       * @return the request
       */
      public Get get(java.lang.String customer, java.lang.String featureKey)
          throws java.io.IOException {
       ...
       * Inserts a feature.
       *
       * <p>Create a request for the method "features.insert".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
       *
       ...
       */
      public Insert insert(
          java.lang.String customer, com.google.api.services.directory.model.Feature content)
          throws java.io.IOException {
        Insert result = new Insert(customer, content);
        initialize(result);
        return result;
       ...
       *
       * <p>Create a request for the method "features.list".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link List#execute()} method to invoke the remote operation.
       *
       ...
       *
       * <p>Create a request for the method "features.patch".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Patch#execute()} method to invoke the remote operation.
       *
      ...
      public Patch patch(
          ...
          com.google.api.services.directory.model.Feature content)
          throws java.io.IOException {
       ...
       * Renames a feature.
       *
       * <p>Create a request for the method "features.rename".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
      ...
      public Rename rename(
          ...
          com.google.api.services.directory.model.FeatureRename content)
          throws java.io.IOException {
       ...
       * Updates a feature.
       *
       * <p>Create a request for the method "features.update".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Update#execute()} method to invoke the remote operation.
       *
      ...
      public class Delete extends DirectoryRequest<Void> {
        ...
        @com.google.api.client.util.Key private java.lang.String featureKey;
        ...
        protected Delete(java.lang.String customer, java.lang.String featureKey) {
          ...
          this.featureKey =
              com.google.api.client.util.Preconditions.checkNotNull(
                  featureKey, "Required parameter featureKey must be specified.");
        }
      ...
      public class Get extends DirectoryRequest<com.google.api.services.directory.model.Feature> {
        ...
        protected Get(java.lang.String customer, java.lang.String featureKey) {
          super(
              ...
              REST_PATH,
              null,
              com.google.api.services.directory.model.Feature.class);
          this.customer =
              com.google.api.client.util.Preconditions.checkNotNull(
                  customer, "Required parameter customer must be specified.");
          this.featureKey =
      ...
      public class Insert
          extends DirectoryRequest<com.google.api.services.directory.model.Feature> {
      ...
      public class List extends DirectoryRequest<com.google.api.services.directory.model.Features> {
        ...
        protected List(java.lang.String customer) {
          super(
              ...
              REST_PATH,
              null,
              com.google.api.services.directory.model.Features.class);
          this.customer =
              com.google.api.client.util.Preconditions.checkNotNull(
                  customer, "Required parameter customer must be specified.");
        }
      ...
      public class Rename extends DirectoryRequest<Void> {
        ...
        @com.google.api.client.util.Key private java.lang.String oldName;
        ...
        protected Rename(
          ...
          this.oldName =
              com.google.api.client.util.Preconditions.checkNotNull(
                  oldName, "Required parameter oldName must be specified.");
        }
  ...
  public class RoleAssignments {
     ...
     *
     * <p>Create a request for the method "roleAssignments.delete".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
     *
     ...
     * @return the request
     */
    public Delete delete(java.lang.String customer, java.lang.String roleAssignmentId)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "roleAssignments.get".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Get#execute()} method to invoke the remote operation.
     *
     ...
     * @return the request
     */
    public Get get(java.lang.String customer, java.lang.String roleAssignmentId)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "roleAssignments.insert".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
     *
     ...
     */
    public Insert insert(
        java.lang.String customer, com.google.api.services.directory.model.RoleAssignment content)
        throws java.io.IOException {
      Insert result = new Insert(customer, content);
      initialize(result);
      return result;
     ...
     *
     * <p>Create a request for the method "roleAssignments.list".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link List#execute()} method to invoke the remote operation.
     *
    ...
    public class Delete extends DirectoryRequest<Void> {
      ...
      @com.google.api.client.util.Key private java.lang.String roleAssignmentId;
      ...
      protected Delete(java.lang.String customer, java.lang.String roleAssignmentId) {
        ...
        this.roleAssignmentId =
            com.google.api.client.util.Preconditions.checkNotNull(
                roleAssignmentId, "Required parameter roleAssignmentId must be specified.");
      }
    ...
    public class Get
        extends DirectoryRequest<com.google.api.services.directory.model.RoleAssignment> {
      ...
      protected Get(java.lang.String customer, java.lang.String roleAssignmentId) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.RoleAssignment.class);
        this.customer =
            com.google.api.client.util.Preconditions.checkNotNull(
                customer, "Required parameter customer must be specified.");
        this.roleAssignmentId =
    ...
    public class Insert
      ...
      protected Insert(
          java.lang.String customer,
          com.google.api.services.directory.model.RoleAssignment content) {
        super(
            Directory.this,
            "POST",
            REST_PATH,
    ...
    public class List
       ...
       */
      @com.google.api.client.util.Key private java.lang.String roleId;
      /**
      ...
      protected List(java.lang.String customer) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.RoleAssignments.class);
        this.customer =
            com.google.api.client.util.Preconditions.checkNotNull(
                customer, "Required parameter customer must be specified.");
      }
  ...
  public class Roles {
     ...
     * Deletes a role.
     *
     * <p>Create a request for the method "roles.delete".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
     *
     ...
     * @return the request
     */
    public Delete delete(java.lang.String customer, java.lang.String roleId)
        throws java.io.IOException {
     ...
     * Retrieves a role.
     *
     * <p>Create a request for the method "roles.get".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Get#execute()} method to invoke the remote operation.
     *
     ...
     * Creates a role.
     *
     * <p>Create a request for the method "roles.insert".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
     *
     ...
     */
    public Insert insert(
        java.lang.String customer, com.google.api.services.directory.model.Role content)
        throws java.io.IOException {
      Insert result = new Insert(customer, content);
      initialize(result);
      return result;
     ...
     *
     * <p>Create a request for the method "roles.list".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link List#execute()} method to invoke the remote operation.
     *
     ...
     *
     * <p>Create a request for the method "roles.patch".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Patch#execute()} method to invoke the remote operation.
     *
    ...
    public Patch patch(
        ...
        com.google.api.services.directory.model.Role content)
        throws java.io.IOException {
     ...
     * Updates a role.
     *
     * <p>Create a request for the method "roles.update".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Update#execute()} method to invoke the remote operation.
     *
    ...
    public class Delete extends DirectoryRequest<Void> {
      ...
      protected Delete(java.lang.String customer, java.lang.String roleId) {
        ...
        this.roleId =
            com.google.api.client.util.Preconditions.checkNotNull(
                roleId, "Required parameter roleId must be specified.");
      }
    ...
    public class Get extends DirectoryRequest<com.google.api.services.directory.model.Role> {
      ...
      protected Get(java.lang.String customer, java.lang.String roleId) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.Role.class);
        this.customer =
            com.google.api.client.util.Preconditions.checkNotNull(
                customer, "Required parameter customer must be specified.");
        this.roleId =
    ...
    public class List extends DirectoryRequest<com.google.api.services.directory.model.Roles> {
      ...
      protected List(java.lang.String customer) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.Roles.class);
        this.customer =
            com.google.api.client.util.Preconditions.checkNotNull(
                customer, "Required parameter customer must be specified.");
      }
  ...
  public class Schemas {
     ...
     * Delete schema
     *
     * <p>Create a request for the method "schemas.delete".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
     *
     ...
     * @return the request
     */
    public Delete delete(java.lang.String customerId, java.lang.String schemaKey)
        throws java.io.IOException {
     ...
     * Retrieve schema
     *
     * <p>Create a request for the method "schemas.get".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Get#execute()} method to invoke the remote operation.
     *
     ...
     * @return the request
     */
    public Get get(java.lang.String customerId, java.lang.String schemaKey)
        throws java.io.IOException {
     ...
     * Create schema.
     *
     * <p>Create a request for the method "schemas.insert".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
     *
     ...
     */
    public Insert insert(
        java.lang.String customerId, com.google.api.services.directory.model.Schema content)
        throws java.io.IOException {
      Insert result = new Insert(customerId, content);
      initialize(result);
      return result;
     ...
     *
     * <p>Create a request for the method "schemas.list".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link List#execute()} method to invoke the remote operation.
     *
     ...
     *
     * <p>Create a request for the method "schemas.patch".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Patch#execute()} method to invoke the remote operation.
     *
    ...
    public Patch patch(
        ...
        com.google.api.services.directory.model.Schema content)
        throws java.io.IOException {
     ...
     * Update schema
     *
     * <p>Create a request for the method "schemas.update".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Update#execute()} method to invoke the remote operation.
     *
    ...
    public class Delete extends DirectoryRequest<Void> {
      ...
      @com.google.api.client.util.Key private java.lang.String schemaKey;
      ...
      protected Delete(java.lang.String customerId, java.lang.String schemaKey) {
        ...
        this.schemaKey =
            com.google.api.client.util.Preconditions.checkNotNull(
                schemaKey, "Required parameter schemaKey must be specified.");
      }
    ...
    public class Get extends DirectoryRequest<com.google.api.services.directory.model.Schema> {
      ...
      protected Get(java.lang.String customerId, java.lang.String schemaKey) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.Schema.class);
        this.customerId =
            com.google.api.client.util.Preconditions.checkNotNull(
                customerId, "Required parameter customerId must be specified.");
        this.schemaKey =
    ...
    public class List extends DirectoryRequest<com.google.api.services.directory.model.Schemas> {
      ...
      protected List(java.lang.String customerId) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.Schemas.class);
        this.customerId =
            com.google.api.client.util.Preconditions.checkNotNull(
                customerId, "Required parameter customerId must be specified.");
      }
  ...
  public class Tokens {
     ...
     *
     * <p>Create a request for the method "tokens.delete".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
     *
     ...
     * @return the request
     */
    public Delete delete(java.lang.String userKey, java.lang.String clientId)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "tokens.get".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Get#execute()} method to invoke the remote operation.
     *
     ...
     *
     * <p>Create a request for the method "tokens.list".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link List#execute()} method to invoke the remote operation.
     *
    ...
    public class Delete extends DirectoryRequest<Void> {
      ...
      @com.google.api.client.util.Key private java.lang.String clientId;
      ...
      protected Delete(java.lang.String userKey, java.lang.String clientId) {
        ...
        this.clientId =
            com.google.api.client.util.Preconditions.checkNotNull(
                clientId, "Required parameter clientId must be specified.");
      }
    ...
    public class Get extends DirectoryRequest<com.google.api.services.directory.model.Token> {
      ...
      protected Get(java.lang.String userKey, java.lang.String clientId) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.Token.class);
        this.userKey =
            com.google.api.client.util.Preconditions.checkNotNull(
                userKey, "Required parameter userKey must be specified.");
        this.clientId =
    ...
    public class List extends DirectoryRequest<com.google.api.services.directory.model.Tokens> {
      ...
      protected List(java.lang.String userKey) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.Tokens.class);
        this.userKey =
            com.google.api.client.util.Preconditions.checkNotNull(
                userKey, "Required parameter userKey must be specified.");
      }
  ...
  public class TwoStepVerification {
     ...
     *
     * <p>Create a request for the method "twoStepVerification.turnOff".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
    ...
    public class TurnOff extends DirectoryRequest<Void> {
       ...
       *
       * <p>This request holds the parameters needed by the the admin server. After setting any
       * optional parameters, call the {@link TurnOff#execute()} method to invoke the remote
       * operation.
       *
       * <p>{@link
       * TurnOff#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
       * must be called to initialize this instance immediately after invoking the constructor.
       *
       * @param userKey Identifies the user in the API request. The value can be the user's primary
       *     email address, alias email address, or unique user ID.
  ...
  public class Users {
     ...
     * Deletes a user.
     *
     * <p>Create a request for the method "users.delete".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
     *
     ...
     * Retrieves a user.
     *
     * <p>Create a request for the method "users.get".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Get#execute()} method to invoke the remote operation.
     *
     ...
     * Creates a user.
     *
     * <p>Create a request for the method "users.insert".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
     *
     ...
     * @return the request
     */
    public Insert insert(com.google.api.services.directory.model.User content)
        throws java.io.IOException {
      Insert result = new Insert(content);
      initialize(result);
      return result;
     ...
     *
     * <p>Create a request for the method "users.list".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link List#execute()} method to invoke the remote operation.
     *
     ...
     *
     * <p>Create a request for the method "users.makeAdmin".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
    ...
    public MakeAdmin makeAdmin(
        java.lang.String userKey, com.google.api.services.directory.model.UserMakeAdmin content)
        throws java.io.IOException {
     ...
     * supports patch semantics and has better performance. This method is unable to clear fields
     * that contain repeated objects (`addresses`, `phones`, etc). Use the update method instead.
     *
     * <p>Create a request for the method "users.patch".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Patch#execute()} method to invoke the remote operation.
     *
     ...
     */
    public Patch patch(
        java.lang.String userKey, com.google.api.services.directory.model.User content)
        throws java.io.IOException {
    ...
    /**
     * Sign a user out of all web and device sessions and reset their sign-in cookies. User will
     * have to sign in by authenticating again.
     *
     * <p>Create a request for the method "users.signOut".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link SignOut#execute()} method to invoke the remote operation.
     *
     * @param userKey Identifies the target user in the API request. The value can be the user's
     ...
     *
     * <p>Create a request for the method "users.undelete".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     ...
     * @return the request
     */
    public Undelete undelete(
        java.lang.String userKey, com.google.api.services.directory.model.UserUndelete content)
        throws java.io.IOException {
     ...
     *
     * <p>Create a request for the method "users.update".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link Update#execute()} method to invoke the remote operation.
     *
     ...
     *
     * <p>Create a request for the method "users.watch".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     ...
     * @return the request
     */
    public Watch watch(com.google.api.services.directory.model.Channel content)
        throws java.io.IOException {
    ...
    public class Get extends DirectoryRequest<com.google.api.services.directory.model.User> {
       ...
       */
      @com.google.api.client.util.Key private java.lang.String customFieldMask;
       ...
       */
      @com.google.api.client.util.Key private java.lang.String viewType;
      ...
      /**
       * Whether to fetch the administrator-only or domain-wide public view of the user. For more
       * information, see [Retrieve a user as a
    ...
    public class List extends DirectoryRequest<com.google.api.services.directory.model.Users> {
      ...
      @com.google.api.client.util.Key private java.lang.String event;
      /** Maximum number of results to return. */
      @com.google.api.client.util.Key private java.lang.Integer maxResults;
      ...
      @com.google.api.client.util.Key private java.lang.String showDeleted;
      ...
      protected List() {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.Users.class);
      }
    ...
    public class MakeAdmin extends DirectoryRequest<Void> {
       ...
       *
       * <p>This request holds the parameters needed by the the admin server. After setting any
       * optional parameters, call the {@link MakeAdmin#execute()} method to invoke the remote
       * operation.
       *
       * <p>{@link
    ...
    public class Patch extends DirectoryRequest<com.google.api.services.directory.model.User> {
      ...
      /**
       * Updates a user using patch semantics. The update method should be used instead, since it
       * also supports patch semantics and has better performance. This method is unable to clear
       * fields that contain repeated objects (`addresses`, `phones`, etc). Use the update method
       * instead.
       *
       * <p>Create a request for the method "users.patch".
       *
    ...
    public class SignOut extends DirectoryRequest<Void> {
       ...
       *
       * <p>This request holds the parameters needed by the the admin server. After setting any
       * optional parameters, call the {@link SignOut#execute()} method to invoke the remote
       * operation.
       *
       * <p>{@link
       * SignOut#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
       * must be called to initialize this instance immediately after invoking the constructor.
       *
       * @param userKey Identifies the target user in the API request. The value can be the user's
       *     primary email address, alias email address, or unique user ID.
    ...
    public class Undelete extends DirectoryRequest<Void> {
       ...
       *
       * <p>This request holds the parameters needed by the the admin server. After setting any
       * optional parameters, call the {@link Undelete#execute()} method to invoke the remote
       * operation.
       *
       * <p>{@link
    ...
    public class Watch extends DirectoryRequest<com.google.api.services.directory.model.Channel> {
       ...
       *
       * <p>This request holds the parameters needed by the the admin server. After setting any
       * optional parameters, call the {@link Watch#execute()} method to invoke the remote
       * operation.
       *
       * <p>{@link
       * Watch#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
       * must be called to initialize this instance immediately after invoking the constructor.
       *
       * @param content the {@link com.google.api.services.directory.model.Channel}
       * @since 1.13
      ...
      protected Watch(com.google.api.services.directory.model.Channel content) {
        super(
            ...
            REST_PATH,
            content,
            com.google.api.services.directory.model.Channel.class);
      }
    ...
    public class Aliases {
       ...
       * @return the request
       */
      public Delete delete(java.lang.String userKey, java.lang.String alias)
          throws java.io.IOException {
       ...
       */
      public Insert insert(
          java.lang.String userKey, com.google.api.services.directory.model.Alias content)
          throws java.io.IOException {
       ...
       * Watch for changes in users list.
       *
       * <p>Create a request for the method "aliases.watch".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Watch#execute()} method to invoke the remote operation.
       *
       ...
       */
      public Watch watch(
          java.lang.String userKey, com.google.api.services.directory.model.Channel content)
          throws java.io.IOException {
      ...
      public class Delete extends DirectoryRequest<Void> {
         ...
         * must be called to initialize this instance immediately after invoking the constructor.
         *
         * @param userKey Identifies the user in the API request. The value can be the user's
         *     primary email address, alias email address, or unique user ID.
         * @param alias The alias to be removed.
         * @since 1.13
         */
    ...
    public class Photos {
       ...
       *
       * <p>Create a request for the method "photos.delete".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Delete#execute()} method to invoke the remote operation.
       *
       ...
       *
       * <p>Create a request for the method "photos.get".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Get#execute()} method to invoke the remote operation.
       *
       ...
       * sdk/directory/v1/guides/performance#patch).
       *
       * <p>Create a request for the method "photos.patch".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Patch#execute()} method to invoke the remote operation.
       *
       ...
       */
      public Patch patch(
          java.lang.String userKey, com.google.api.services.directory.model.UserPhoto content)
          throws java.io.IOException {
        Patch result = new Patch(userKey, content);
        initialize(result);
        return result;
       ...
       *
       * <p>Create a request for the method "photos.update".
       *
       * <p>This request holds the parameters needed by the admin server. After setting any optional
       * parameters, call the {@link Update#execute()} method to invoke the remote operation.
       *
      ...
      public class Get extends DirectoryRequest<com.google.api.services.directory.model.UserPhoto> {
        ...
        protected Get(java.lang.String userKey) {
          super(
              ...
              REST_PATH,
              null,
              com.google.api.services.directory.model.UserPhoto.class);
          this.userKey =
              com.google.api.client.util.Preconditions.checkNotNull(
                  userKey, "Required parameter userKey must be specified.");
        }
      ...
      public class Patch
          extends DirectoryRequest<com.google.api.services.directory.model.UserPhoto> {
  ...
  public class VerificationCodes {
     ...
     *
     * <p>Create a request for the method "verificationCodes.generate".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     ...
     *
     * <p>Create a request for the method "verificationCodes.invalidate".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     ...
     *
     * <p>Create a request for the method "verificationCodes.list".
     *
     * <p>This request holds the parameters needed by the admin server. After setting any optional
     * parameters, call the {@link List#execute()} method to invoke the remote operation.
     *
    ...
    public class Generate extends DirectoryRequest<Void> {
       ...
       *
       * <p>This request holds the parameters needed by the the admin server. After setting any
       * optional parameters, call the {@link Generate#execute()} method to invoke the remote
       * operation.
       *
       * <p>{@link
    ...
    public class List
      ...
      protected List(java.lang.String userKey) {
        super(
            ...
            REST_PATH,
            null,
            com.google.api.services.directory.model.VerificationCodes.class);
        this.userKey =
            com.google.api.client.util.Preconditions.checkNotNull(
                userKey, "Required parameter userKey must be specified.");
      }
