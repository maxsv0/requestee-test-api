...
public final class BuildingAddress extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Unstructured address lines describing the lower levels of an address. The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private java.util.List<java.lang.String> addressLines;
   ...
   */
  @com.google.api.client.util.Key private java.lang.String administrativeArea;

  /**
   * Optional. BCP-47 language code of the contents of this address (if known). The value may be
   * {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String languageCode;
   ...
   * fit into this structure well, leave locality empty and use addressLines. The value may be
   * {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String locality;

  /** Optional. Postal code of the address. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String postalCode;

  /**
   * Required. CLDR region code of the country/region of the address. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String regionCode;

  /** Optional. Sublocality of the address. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String sublocality;
