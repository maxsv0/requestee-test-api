...
public final class UserIm extends com.google.api.client.json.GenericJson {
  ...
  /** Custom protocol. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String customProtocol;

  /** Custom type. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String customType;

  /** Instant messenger id. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String im;

  /**
   * If this is user's primary im. Only one entry could be marked as primary. The value may be
   * {@code null}.
   */
   ...
   * field. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String protocol;
