...
public final class OrgUnit extends com.google.api.client.json.GenericJson {
   ...
   * center](https://support.google.com/a/answer/4352075). The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean blockInheritance;

  /** Description of the organizational unit. The value may be {@code null}. */
   ...
   * /corp/support/sales_support parent path is sales_support. Required. The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private java.lang.String name;

  /** The unique ID of the organizational unit. The value may be {@code null}. */
   ...
   * sdk/directory/v1/guides/manage-users.html#update_user). The value may be {@code null}.
   */
   ...
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String parentOrgUnitId;

  /**
   * The organizational unit's parent path. For example, /corp/sales is the parent path for
   * /corp/sales/sales_support organizational unit. Required, unless `parentOrgUnitId` is set. The
   * value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String parentOrgUnitPath;
