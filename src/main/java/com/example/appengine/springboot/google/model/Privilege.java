...
public final class Privilege extends com.google.api.client.json.GenericJson {
   ...
   * list of child privileges; this list is empty for a leaf privilege. The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private java.util.List<Privilege> childPrivileges;

  /** ETag of the resource. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String etag;

  /** If the privilege can be restricted to an organization unit. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Boolean isOuScopable;

  /**
   * The type of the API resource. This is always `admin#directory#privilege`. The value may be
   * {@code null}.
   */
  ...
  /** The name of the service this privilege is for. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String serviceName;
