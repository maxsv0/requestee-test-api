...
public final class Domains extends com.google.api.client.json.GenericJson {
   ...
   * format. (Read-only). The value may be {@code null}.
   */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString
  private java.lang.Long creationTime;
  /** List of domain alias objects. (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.util.List<DomainAlias> domainAliases;
  /** The domain name of the customer. The value may be {@code null}. */
  ...
  /** Indicates if the domain is a primary domain (Read-only). The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Boolean isPrimary;

  /** Kind of resource this is. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String kind;

  /** Indicates the verification state of a domain. (Read-only). The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Boolean verified;
