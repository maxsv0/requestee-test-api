...
public final class Asps extends com.google.api.client.json.GenericJson {
  ...
  /** A list of ASP resources. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.util.List<Asp> items;
  /**
   * The type of the API resource. This is always `admin#directory#aspList`. The value may be {@code
   * null}.
   */
