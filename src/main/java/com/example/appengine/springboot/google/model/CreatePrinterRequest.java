...
public final class CreatePrinterRequest extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Required. The name of the customer. Format: customers/{customer_id} The value may be {@code
   * null}.
   */
   ...
   * populate printer.org_unit_id filed. Otherwise the printer will be placed under root OU. The
