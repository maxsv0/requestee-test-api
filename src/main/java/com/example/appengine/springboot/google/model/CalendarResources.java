...
public final class CalendarResources extends com.google.api.client.json.GenericJson {
  ...
  static {
    // hack to force ProGuard to consider CalendarResource used, since otherwise it would be
    // stripped out
  ...
  /** The CalendarResources in this page of results. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.util.List<CalendarResource> items;
  /**
   * Identifies this as a collection of CalendarResources. This is always
   * `admin#directory#resources#calendars#calendarResourcesList`. The value may be {@code null}.
   */
