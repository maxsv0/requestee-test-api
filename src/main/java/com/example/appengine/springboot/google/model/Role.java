...
public final class Role extends com.google.api.client.json.GenericJson {
  ...
  static {
    // hack to force ProGuard to consider RolePrivileges used, since otherwise it would be stripped
    // out
  ...
  /** Returns `true` if the role is a super admin role. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Boolean isSuperAdminRole;
  /** Returns `true` if this is a pre-defined system role. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Boolean isSystemRole;
  /**
   * The type of the API resource. This is always `admin#directory#role`. The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private java.lang.String kind;
  /** A short description of the role. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String roleDescription;
  /** ID of the role. The value may be {@code null}. */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString
  private java.lang.Long roleId;
  /** Name of the role. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String roleName;
  /** The set of privileges that are granted to this role. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.util.List<RolePrivileges> rolePrivileges;
  ...
  public static final class RolePrivileges extends com.google.api.client.json.GenericJson {
    ...
    /** The name of the privilege. The value may be {@code null}. */
    @com.google.api.client.util.Key private java.lang.String privilegeName;

    /**
     * The obfuscated ID of the service this privilege is for. This value is returned with
     * [`Privileges.list()`](/admin-sdk/directory/v1/reference/privileges/list). The value may be
     * {@code null}.
     */
    @com.google.api.client.util.Key private java.lang.String serviceId;
