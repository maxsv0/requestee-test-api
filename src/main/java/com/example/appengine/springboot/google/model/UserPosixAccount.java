...
public final class UserPosixAccount extends com.google.api.client.json.GenericJson {
  ...
  /** A POSIX account field identifier. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String accountId;

  /** The GECOS (user information) for this account. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String gecos;

  /** The default group ID. The value may be {@code null}. */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString
  private java.math.BigInteger gid;

  /** The path to the home directory for this account. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String homeDirectory;

  /** The operating system type for this account. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String operatingSystemType;

  /** If this is user's primary account within the SystemId. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Boolean primary;

  /** The path to the login shell for this account. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String shell;

  /**
   * System identifier for which account Username or Uid apply to. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String systemId;

  /** The POSIX compliant user ID. The value may be {@code null}. */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString
  private java.math.BigInteger uid;

  /** The username of the account. The value may be {@code null}. */
