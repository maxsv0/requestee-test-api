...
public final class Asp extends com.google.api.client.json.GenericJson {
  ...
  /** The unique ID of the ASP. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Integer codeId;

  /**
   * The time when the ASP was created. Expressed in [Unix
   * time](https://en.wikipedia.org/wiki/Epoch_time) format. The value may be {@code null}.
   */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString
  private java.lang.Long creationTime;

  /** ETag of the ASP. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String etag;

  /**
   * The type of the API resource. This is always `admin#directory#asp`. The value may be {@code
   * null}.
   */
   ...
   * was created. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String name;

  /** The unique ID of the user who issued the ASP. The value may be {@code null}. */
