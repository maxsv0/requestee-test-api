...
public final class SchemaFieldSpec extends com.google.api.client.json.GenericJson {
  ...
  /** Display Name of the field. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String displayName;

  /** The ETag of the field. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String etag;

  /** The unique identifier of the field (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String fieldId;

  /** The name of the field. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String fieldName;

  /** The type of the field. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String fieldType;

  /**
   * Boolean specifying whether the field is indexed or not. Default: `true`. The value may be
   * {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean indexed;

  /**
   * The kind of resource this is. For schema fields this is always
   * `admin#directory#schema#fieldspec`. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String kind;

  /**
   * A boolean specifying whether this is a multi-valued field or not. Default: `false`. The value
   * may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean multiValued;

  /**
   * Indexing spec for a numeric field. By default, only exact match queries will be supported for
   * numeric fields. Setting the `numericIndexingSpec` allows range queries to be supported. The
   * value may be {@code null}.
   */
  @com.google.api.client.util.Key private NumericIndexingSpec numericIndexingSpec;
   ...
   * Note: It may take up to 24 hours for changes to this field to be reflected. The value may be
   * {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String readAccessType;
   ...
   *
   * <p>Boolean properties can have four possible values: {@code null}, {@link
   * com.google.api.client.util.Data#NULL_BOOLEAN}, {@link Boolean#TRUE} or {@link Boolean#FALSE}.
   *
   * <p>This method returns {@link Boolean#TRUE} if the default of the property is {@link
   * Boolean#TRUE} and it is {@code null} or {@link com.google.api.client.util.Data#NULL_BOOLEAN}.
   * {@link Boolean#FALSE} is returned if the default of the property is {@link Boolean#FALSE} and
   * it is {@code null} or {@link com.google.api.client.util.Data#NULL_BOOLEAN}.
   *
   * <p>Boolean specifying whether the field is indexed or not. Default: `true`.
   */
  ...
  public static final class NumericIndexingSpec extends com.google.api.client.json.GenericJson {
     ...
     * outside this range will still be indexed, but search may not be as performant. The value may
     * be {@code null}.
     */
    @com.google.api.client.util.Key private java.lang.Double maxValue;
     ...
     * be {@code null}.
     */
    @com.google.api.client.util.Key private java.lang.Double minValue;
