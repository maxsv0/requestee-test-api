...
public final class RoleAssignment extends com.google.api.client.json.GenericJson {
  ...
  /** The unique ID of the user this role is assigned to. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String assignedTo;

  /** ETag of the resource. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String etag;

  /**
   * The type of the API resource. This is always `admin#directory#roleAssignment`. The value may be
   * {@code null}.
   */
   ...
   * unit the exercise of this role is restricted to. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String orgUnitId;

  /** ID of this roleAssignment. The value may be {@code null}. */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString
  private java.lang.Long roleAssignmentId;

  /** The ID of the role that is assigned. The value may be {@code null}. */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString
  private java.lang.Long roleId;

  /** The scope in which this role is assigned. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String scopeType;
