...
public final class MobileDevice extends com.google.api.client.json.GenericJson {
  ...
  static {
    // hack to force ProGuard to consider Applications used, since otherwise it would be stripped
    // out
  ...
  /**
   * Adb (USB debugging) enabled or disabled on device (Read-only) The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean adbStatus;
  /**
   ...
   * with five applications, the is now the updated list of five applications. The value may be
   * {@code null}.
   */
  @com.google.api.client.util.Key private java.util.List<Applications> applications;
  /** The device's baseband version. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String basebandVersion;

  /** Mobile Device Bootloader version (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String bootloaderVersion;

  /** Mobile Device Brand (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String brand;

  /** The device's operating system build number. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String buildNumber;

  /** The default locale used on the device. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String defaultLanguage;

  /** Developer options enabled or disabled on device (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Boolean developerOptionsStatus;

  /** The compromised device status. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String deviceCompromisedStatus;

  /**
   * The serial number for a Google Sync mobile device. For Android and iOS devices, this is a
   * software generated unique identifier. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String deviceId;

  /** DevicePasswordStatus (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String devicePasswordStatus;
   ...
   * method. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.util.List<java.lang.String> email;

  /** Mobile Device Encryption Status (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String encryptionStatus;
   ...
   */
  @com.google.api.client.util.Key private com.google.api.client.util.DateTime firstSync;

  /** Mobile Device Hardware (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String hardware;
   ...
   * of these devices, this is a read-only property. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String hardwareId;

  /** The device's IMEI number. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String imei;

  /** The device's kernel version. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String kernelVersion;

  /**
   * The type of the API resource. For Mobiledevices resources, the value is
   * `admin#directory#mobiledevice`. The value may be {@code null}.
   */
  ...
  /**
   * Boolean indicating if this account is on owner/primary profile or not. The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean managedAccountIsOnOwnerProfile;

  /** Mobile Device manufacturer (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String manufacturer;

  /** The device's MEID number. The value may be {@code null}. */
   ...
   * ](/admin-sdk/directory/v1/guides/manage-users#get_user). The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.util.List<java.lang.String> name;

  /**
   * Mobile Device mobile or network operator (if available) (Read-only) The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private java.lang.String networkOperator;
   ...
   * devices#update_mobile_device). The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String os;

  /** List of accounts added on device (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.util.List<java.lang.String> otherAccountsInfo;

  /** DMAgentPermission (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String privilege;

  /** Mobile Device release version version (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String releaseVersion;

  /**
   * The unique ID the API service uses to identify the mobile device. The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private java.lang.String resourceId;

  /** Mobile Device Security patch level (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString
  private java.lang.Long securityPatchLevel;

  /** The device's serial number. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String serialNumber;

  /** The device's status. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String status;

  /** Work profile supported on device (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Boolean supportsWorkProfile;

  /** The type of mobile device. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String type;

  /** Unknown sources enabled or disabled on device (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Boolean unknownSourcesStatus;
   ...
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String userAgent;

  /** The device's MAC address on Wi-Fi networks. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String wifiMacAddress;
   ...
   */
  public MobileDevice setManagedAccountIsOnOwnerProfile(
      java.lang.Boolean managedAccountIsOnOwnerProfile) {
  ...
  public static final class Applications extends com.google.api.client.json.GenericJson {
    ...
    /** The application's display name. An example is `Browser`. The value may be {@code null}. */
    @com.google.api.client.util.Key private java.lang.String displayName;

    /**
     * The application's package name. An example is `com.android.browser`. The value may be {@code
     * null}.
     */
    @com.google.api.client.util.Key private java.lang.String packageName;

    /**
     * The list of permissions of this application. These can be either a standard Android
     * permission or one defined by the application, and are found in an application's [Android
     ...
     * The value may be {@code null}.
     */
    @com.google.api.client.util.Key private java.util.List<java.lang.String> permission;

    /** The application's version code. An example is `13`. The value may be {@code null}. */
    @com.google.api.client.util.Key private java.lang.Integer versionCode;

    /**
     * The application's version name. An example is `3.2-140714`. The value may be {@code null}.
     */
    @com.google.api.client.util.Key private java.lang.String versionName;
