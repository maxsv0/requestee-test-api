...
public final class UserAddress extends com.google.api.client.json.GenericJson {
  ...
  /** Country. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String country;

  /** Country code. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String countryCode;

  /** Custom type. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String customType;

  /** Extended Address. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String extendedAddress;

  /** Formatted address. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String formatted;

  /** Locality. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String locality;

  /** Other parts of address. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String poBox;

  /** Postal code. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String postalCode;

  /**
   * If this is user's primary address. Only one entry could be marked as primary. The value may be
   * {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean primary;

  /** Region. The value may be {@code null}. */
   ...
   * might be able to write structured addresses but any values will eventually be clobbered. The
   * value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean sourceIsStructured;

  /** Street. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String streetAddress;
