...
public final class BatchDeletePrintersResponse extends com.google.api.client.json.GenericJson {
  ...
  /** A list of update failures. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.util.List<FailureInfo> failedPrinters;

  /** A list of Printer.id that were successfully deleted. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.util.List<java.lang.String> printerIds;
