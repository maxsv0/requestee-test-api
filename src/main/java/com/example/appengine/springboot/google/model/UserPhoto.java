...
public final class UserPhoto extends com.google.api.client.json.GenericJson {
  ...
  /** Height of the photo in pixels. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Integer height;

  /** The ID the API uses to uniquely identify the user. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String id;

  /**
   * The type of the API resource. For Photo resources, this is `admin#directory#user#photo`. The
   ...
   * safe base64 encoding. The value may be {@code null}.
   */
   ...
   * 96x96 pixels. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String photoData;

  /** The user's primary email address. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String primaryEmail;

  /** Width of the photo in pixels. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Integer width;
