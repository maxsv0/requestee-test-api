...
public final class CalendarResource extends com.google.api.client.json.GenericJson {
  ...
  /** Unique ID for the building a resource is located in. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String buildingId;

  /** Capacity of a resource, number of seats in a room. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Integer capacity;

  /** ETag of the resource. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String etags;

  /** Instances of features for the calendar resource. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Object featureInstances;

  /** Name of the floor a resource is located on. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String floorName;

  /** Name of the section within a floor a resource is located in. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String floorSection;
   ...
   * (16)". The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String generatedResourceName;

  /**
   * The type of the resource. For calendar resources, the value is
   * `admin#directory#resources#calendars#CalendarResource`. The value may be {@code null}.
   */
   ...
   * CATEGORY_UNKNOWN. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String resourceCategory;

  /** Description of the resource, visible only to admins. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String resourceDescription;

  /**
   * The read-only email for the calendar resource. Generated as part of creating a new calendar
   * resource. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String resourceEmail;

  /** The unique ID for the calendar resource. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String resourceId;

  /**
   * The name of the calendar resource. For example, "Training Room 1A". The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private java.lang.String resourceName;

  /**
   * The type of the calendar resource, intended for non-room resources. The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private java.lang.String resourceType;

  /** Description of the resource, visible to users and admins. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String userVisibleDescription;
