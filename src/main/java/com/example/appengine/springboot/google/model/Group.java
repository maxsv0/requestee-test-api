...
public final class Group extends com.google.api.client.json.GenericJson {
  ...
  /**
   * Value is `true` if this group was created by an administrator rather than a user. The value may
   * be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean adminCreated;

  /** List of a group's alias email addresses. The value may be {@code null}. */
   ...
   * property of the parent group. The value may be {@code null}.
   */
   ...
   * the [help center](https://support.google.com/a/answer/9193374) for details. The value may be
   * {@code null}.
   */
  ...
  /**
   * The unique ID of a group. A group `id` can be used as a group request URI's `groupKey`. The
   * value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String id;

  /**
   * The type of the API resource. For Groups resources, the value is `admin#directory#group`. The
   * value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String kind;

  /** The group's display name. The value may be {@code null}. */
   ...
   * PUT request, the edit is ignored by the API service. The value may be {@code null}.
   */
