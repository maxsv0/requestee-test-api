...
public final class User extends com.google.api.client.json.GenericJson {
  ...
  /**
   * A list of the user's addresses. The maximum allowed data size for this field is 10Kb. The value
   * may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Object addresses;

  /**
   * Output only. This property is `true` if the user has completed an initial login and accepted
   * the Terms of Service agreement. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean agreedToTerms;

  /** Output only. A list of the user's alias email addresses. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.util.List<java.lang.String> aliases;

  /** Indicates if user is archived. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Boolean archived;
   ...
   * provider](https://support.google.com/a/answer/60224). The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean changePasswordAtNextLogin;

  /** User's G Suite account creation time. (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private com.google.api.client.util.DateTime creationTime;

  /** Custom fields of the user. The value may be {@code null}. */
   ...
   * of a [users.list](/admin-sdk/directory/v1/reference/users/list) request. The value may be
   * {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String customerId;

  /** The value may be {@code null}. */
  @com.google.api.client.util.Key private com.google.api.client.util.DateTime deletionTime;

  /**
   * A list of the user's email addresses. The maximum allowed data size for this field is 10Kb. The
   * value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Object emails;

  /** Output only. ETag of the resource. The value may be {@code null}. */
   ...
   * data size for this field is 2Kb. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Object externalIds;

  /**
   * The user's gender. The maximum allowed data size for this field is 1Kb. The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private java.lang.Object gender;
   ...
   * [crypt](https://en.wikipedia.org/wiki/Crypt_\(C\)) hash format. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String hashFunction;

  /**
   * The unique ID for the user. A user `id` can be used as a user request URI's `userKey`. The
   * value may be {@code null}.
   */
   ...
   * size for this field is 2Kb. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Object ims;
   ...
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean includeInGlobalAddressList;

  /**
   * If `true`, the user's IP address is [whitelisted](https://support.google.com/a/answer/60752).
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean ipWhitelisted;
   ...
   * The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean isAdmin;
   ...
   * using the [Admin console](https://support.google.com/a/answer/33325). The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean isDelegatedAdmin;

  /** Output only. Is 2-step verification enforced (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Boolean isEnforcedIn2Sv;

  /** Output only. Is enrolled in 2-step verification (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Boolean isEnrolledIn2Sv;

  /**
   * Output only. Indicates if the user's Google mailbox is created. This property is only
   * applicable if the user has been assigned a Gmail license. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean isMailboxSetup;

  /**
   * The user's keywords. The maximum allowed data size for this field is 1Kb. The value may be
   * {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Object keywords;

  /**
   * Output only. The type of the API resource. For Users resources, the value is
   * `admin#directory#user`. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String kind;

  /**
   * The user's languages. The maximum allowed data size for this field is 1Kb. The value may be
   * {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Object languages;

  /** User's last login time. (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private com.google.api.client.util.DateTime lastLoginTime;

  /**
   * The user's locations. The maximum allowed data size for this field is 10Kb. The value may be
   * {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Object locations;
   ...
   * Maximum allowed data size for this field is 1Kb. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private UserName name;

  /**
   * Output only. List of the user's non-editable alias email addresses. These are typically outside
   * the account's primary domain or sub-domain. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.util.List<java.lang.String> nonEditableAliases;

  /** Notes for the user. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Object notes;

  /**
   * The full path of the parent organization associated with the user. If the parent organization
   * is the top-level, it is represented as a forward slash (`/`). The value may be {@code null}.
   */
   ...
   * 10Kb. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Object organizations;

  /** User's password The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String password;

  /**
   * A list of the user's phone numbers. The maximum allowed data size for this field is 1Kb. The
   * value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Object phones;

  /**
   * A list of [POSIX](https://www.opengroup.org/austin/papers/posix_faq.html) account information
   * for the user. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Object posixAccounts;

  /**
   * The user's primary email address. This property is required in a request to create a user
   * account. The `primaryEmail` must be unique and cannot be an alias of another user. The value
   * may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String primaryEmail;

  /** Recovery email of the user. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String recoveryEmail;

  /**
   * Recovery phone of the user. The phone number must be in the E.164 format, starting with the
   * plus sign (+). Example: *+16506661212*. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String recoveryPhone;

  /**
   * A list of the user's relationships to other users. The maximum allowed data size for this field
   * is 2Kb. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Object relations;

  /** A list of SSH public keys. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Object sshPublicKeys;

  /** Indicates if user is suspended. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Boolean suspended;
   ...
   * `true`. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String suspensionReason;

  /** Output only. ETag of the user's photo (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String thumbnailPhotoEtag;

  /** Output only. Photo Url of the user (Read-only) The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String thumbnailPhotoUrl;

  /**
   * The user's websites. The maximum allowed data size for this field is 2Kb. The value may be
   * {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Object websites;
   ...
   */
  public User setCustomSchemas(
      java.util.Map<String, java.util.Map<String, java.lang.Object>> customSchemas) {
