...
public final class Channel extends com.google.api.client.json.GenericJson {
  ...
  /**
   * The address where notifications are delivered for this channel. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String address;

  /**
   * Date and time of notification channel expiration, expressed as a Unix timestamp, in
   * milliseconds. Optional. The value may be {@code null}.
   */
  @com.google.api.client.util.Key @com.google.api.client.json.JsonString
  private java.lang.Long expiration;

  /**
   * A UUID or similar unique string that identifies this channel. The value may be {@code null}.
   */
   ...
   * `api#channel`. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String kind;

  /**
   * Additional parameters controlling delivery channel behavior. Optional. The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private java.util.Map<String, java.lang.String> params;

  /**
   * A Boolean value to indicate whether payload is wanted. Optional. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean payload;

  /**
   * An opaque ID that identifies the resource being watched on this channel. Stable across
   * different API versions. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String resourceId;

  /** A version-specific identifier for the watched resource. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String resourceUri;

  /**
   * An arbitrary string delivered to the target address with each notification delivered over this
   * channel. Optional. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String token;

  /** The type of delivery mechanism used for this channel. The value may be {@code null}. */
