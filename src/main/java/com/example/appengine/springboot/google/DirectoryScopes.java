...
public class DirectoryScopes {
   ...
   */
  public static final String ADMIN_CHROME_PRINTERS =
      "https://www.googleapis.com/auth/admin.chrome.printers";

  /** See the printers that your organization can use with Chrome. */
  public static final String ADMIN_CHROME_PRINTERS_READONLY =
      "https://www.googleapis.com/auth/admin.chrome.printers.readonly";

  /** View and manage customer related information. */
  public static final String ADMIN_DIRECTORY_CUSTOMER =
      "https://www.googleapis.com/auth/admin.directory.customer";

  /** View customer related information. */
  public static final String ADMIN_DIRECTORY_CUSTOMER_READONLY =
      "https://www.googleapis.com/auth/admin.directory.customer.readonly";

  /** View and manage your Chrome OS devices' metadata. */
  public static final String ADMIN_DIRECTORY_DEVICE_CHROMEOS =
      "https://www.googleapis.com/auth/admin.directory.device.chromeos";

  /** View your Chrome OS devices' metadata. */
  public static final String ADMIN_DIRECTORY_DEVICE_CHROMEOS_READONLY =
      "https://www.googleapis.com/auth/admin.directory.device.chromeos.readonly";

  /** View and manage your mobile devices' metadata. */
  public static final String ADMIN_DIRECTORY_DEVICE_MOBILE =
      "https://www.googleapis.com/auth/admin.directory.device.mobile";

  /** Manage your mobile devices by performing administrative tasks. */
  public static final String ADMIN_DIRECTORY_DEVICE_MOBILE_ACTION =
      "https://www.googleapis.com/auth/admin.directory.device.mobile.action";

  /** View your mobile devices' metadata. */
  public static final String ADMIN_DIRECTORY_DEVICE_MOBILE_READONLY =
      "https://www.googleapis.com/auth/admin.directory.device.mobile.readonly";

  /** View and manage the provisioning of domains for your customers. */
  public static final String ADMIN_DIRECTORY_DOMAIN =
      "https://www.googleapis.com/auth/admin.directory.domain";

  /** View domains related to your customers. */
  public static final String ADMIN_DIRECTORY_DOMAIN_READONLY =
  ...
  public static final String ADMIN_DIRECTORY_GROUP_MEMBER =
      "https://www.googleapis.com/auth/admin.directory.group.member";

  /** View group subscriptions on your domain. */
  public static final String ADMIN_DIRECTORY_GROUP_MEMBER_READONLY =
      "https://www.googleapis.com/auth/admin.directory.group.member.readonly";

  /** View groups on your domain. */
  public static final String ADMIN_DIRECTORY_GROUP_READONLY =
  ...
  public static final String ADMIN_DIRECTORY_ORGUNIT_READONLY =
      "https://www.googleapis.com/auth/admin.directory.orgunit.readonly";

  /** View and manage the provisioning of calendar resources on your domain. */
  public static final String ADMIN_DIRECTORY_RESOURCE_CALENDAR =
      "https://www.googleapis.com/auth/admin.directory.resource.calendar";

  /** View calendar resources on your domain. */
  public static final String ADMIN_DIRECTORY_RESOURCE_CALENDAR_READONLY =
      "https://www.googleapis.com/auth/admin.directory.resource.calendar.readonly";

  /** Manage delegated admin roles for your domain. */
  public static final String ADMIN_DIRECTORY_ROLEMANAGEMENT =
      "https://www.googleapis.com/auth/admin.directory.rolemanagement";

  /** View delegated admin roles for your domain. */
  public static final String ADMIN_DIRECTORY_ROLEMANAGEMENT_READONLY =
  ...
  public static final String ADMIN_DIRECTORY_USER_ALIAS =
      "https://www.googleapis.com/auth/admin.directory.user.alias";

  /** View user aliases on your domain. */
  public static final String ADMIN_DIRECTORY_USER_ALIAS_READONLY =
      "https://www.googleapis.com/auth/admin.directory.user.alias.readonly";

  /** See info about users on your domain. */
  public static final String ADMIN_DIRECTORY_USER_READONLY =
      "https://www.googleapis.com/auth/admin.directory.user.readonly";

  /** Manage data access permissions for users on your domain. */
  public static final String ADMIN_DIRECTORY_USER_SECURITY =
      "https://www.googleapis.com/auth/admin.directory.user.security";

  /** View and manage the provisioning of user schemas on your domain. */
  public static final String ADMIN_DIRECTORY_USERSCHEMA =
      "https://www.googleapis.com/auth/admin.directory.userschema";

  /** View user schemas on your domain. */
  public static final String ADMIN_DIRECTORY_USERSCHEMA_READONLY =
