...
public final class Printer extends com.google.api.client.json.GenericJson {
  ...
  static {
    // hack to force ProGuard to consider AuxiliaryMessage used, since otherwise it would be
    // stripped out
  ...
  /**
   * Output only. Auxiliary messages about issues with the printer configuration if any. The value
   * may be {@code null}.
   */
  @com.google.api.client.util.Key private java.util.List<AuxiliaryMessage> auxiliaryMessages;
  /** Output only. Time when printer was created. The value may be {@code null}. */
  @com.google.api.client.util.Key private String createTime;

  /** Editable. Description of printer. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String description;

  /** Editable. Name of printer. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String displayName;

  /** Id of the printer. (During printer creation leave empty) The value may be {@code null}. */
   ...
   * ListPrinterModels response. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String makeAndModel;

  /**
   * The resource name of the Printer object, in the format customers/{customer-id}/printers
   * /{printer-id} (During printer creation leave empty) The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String name;

  /**
   * Organization Unit that owns this printer (Only can be set during Printer creation) The value
   * may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String orgUnitId;

  /** Editable. Printer URI. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String uri;

  /**
   * Editable. flag to use driverless configuration or not. If it's set to be true, make_and_model
   * can be ignored The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean useDriverlessConfig;
