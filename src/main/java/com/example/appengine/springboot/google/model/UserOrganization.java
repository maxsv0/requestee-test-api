...
public final class UserOrganization extends com.google.api.client.json.GenericJson {
  ...
  /** The cost center of the users department. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String costCenter;

  /** Custom type. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String customType;

  /** Department within the organization. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String department;

  /** Description of the organization. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String description;

  /** The domain to which the organization belongs to. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String domain;

  /**
   * The full-time equivalent millipercent within the organization (100000 = 100%). The value may be
   * {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Integer fullTimeEquivalent;

  /**
   * Location of the organization. This need not be fully qualified address. The value may be {@code
   * null}.
   */
  @com.google.api.client.util.Key private java.lang.String location;

  /** Name of the organization The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String name;

  /** If it user's primary organization. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.Boolean primary;

  /** Symbol of the organization. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String symbol;

  /** Title (designation) of the user in the organization. The value may be {@code null}. */
   ...
   * have a CustomType value. The value may be {@code null}.
   */
