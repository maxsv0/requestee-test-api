...
public final class ChromeOsDevices extends com.google.api.client.json.GenericJson {
  ...
  static {
    // hack to force ProGuard to consider ChromeOsDevice used, since otherwise it would be stripped
    // out
    // see https://github.com/google/google-api-java-client/issues/543
    com.google.api.client.util.Data.nullOf(ChromeOsDevice.class);
  }

  /** List of Chrome OS Device objects. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.util.List<ChromeOsDevice> chromeosdevices;
   ...
   * value in the `pageToken` query string of this request. The value may be {@code null}.
   */
