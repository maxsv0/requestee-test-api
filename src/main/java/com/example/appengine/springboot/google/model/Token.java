...
public final class Token extends com.google.api.client.json.GenericJson {
   ...
   * an anonymous Client ID. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean anonymous;

  /** The Client ID of the application the token is issued to. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String clientId;

  /**
   * The displayable name of the application the token is issued to. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.String displayText;

  /** ETag of the resource. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.lang.String etag;

  /**
   * The type of the API resource. This is always `admin#directory#token`. The value may be {@code
   * null}.
   */
   ...
   * is installed to a desktop or mobile device. The value may be {@code null}.
   */
  @com.google.api.client.util.Key private java.lang.Boolean nativeApp;

  /** A list of authorization scopes the application is granted. The value may be {@code null}. */
  @com.google.api.client.util.Key private java.util.List<java.lang.String> scopes;

  /** The unique ID of the user that issued the token. The value may be {@code null}. */
