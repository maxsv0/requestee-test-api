...
/**
 * Directory request initializer for setting properties like key and userIp.
 *
 * <p>The simplest usage is to use it to set the key parameter:
 *
 * <pre>
 * public static final GoogleClientRequestInitializer KEY_INITIALIZER =
 * new DirectoryRequestInitializer(KEY);
 * </pre>
 *
 ...
 * new DirectoryRequestInitializer(KEY, USER_IP);
 * </pre>
 *
 * <p>If you want to implement custom logic, extend it like this:
 *
 * <pre>
 * public static class MyRequestInitializer extends DirectoryRequestInitializer {
 *
 * {@literal @}Override
 * public void initializeDirectoryRequest(DirectoryRequest{@literal <}?{@literal >} request)
 * throws IOException {
 * // custom logic
 * }
 * }
 ...
 *
 * <pre>
 * public static class MyRequestInitializer2 extends DirectoryRequestInitializer {
 *
 ...
 * @since 1.12
 */
public class DirectoryRequestInitializer
  ...
  public DirectoryRequestInitializer(String key) {
    super(key);
  }
   ...
   */
  public DirectoryRequestInitializer(String key, String userIp) {
    super(key, userIp);
  }
  ...
  public final void initializeJsonRequest(
    ...
    initializeDirectoryRequest((DirectoryRequest<?>) request);
  }

  /**
   * Initializes Directory request.
   *
   ...
   */
  protected void initializeDirectoryRequest(DirectoryRequest<?> request)
      throws java.io.IOException {}
}
